...
-- Copiando estrutura do banco de dados para classicmodels
CREATE DATABASE IF NOT EXISTS `classicmodels` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `classicmodels`;

-- Copiando estrutura para tabela classicmodels.categorias
...
-- Copiando dados para a tabela classicmodels.categorias: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `categorias` DISABLE KEYS */;
INSERT INTO `categorias` (`ID_categoria`, `descricao_texto`, `descricao_html`, `imagem`) VALUES
...
-- Copiando estrutura para tabela classicmodels.clientes
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `endereco_linha1` varchar(50) NOT NULL,
  `endereco_linha2` varchar(50) DEFAULT NULL,
  `cidade` varchar(50) NOT NULL,
  `estado` varchar(50) DEFAULT NULL,
  `codigo_postal` varchar(15) DEFAULT NULL,
  `pais` varchar(50) NOT NULL,
  `ID_representante_vendas` int(11) DEFAULT NULL,
  `limite_credito` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`ID_cliente`),
  KEY `salesRepEmployeeNumber` (`ID_representante_vendas`),
  CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`ID_representante_vendas`) REFERENCES `funcionario` (`ID_funcionario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela classicmodels.clientes: ~122 rows (aproximadamente)
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
INSERT INTO `clientes` (`ID_cliente`, `razao_social`, `sobrenome`, `nome`, `telefone`, `endereco_linha1`, `endereco_linha2`, `cidade`, `estado`, `codigo_postal`, `pais`, `ID_representante_vendas`, `limite_credito`) VALUES
...
-- Copiando estrutura para tabela classicmodels.escritorios
CREATE TABLE IF NOT EXISTS `escritorios` (
  `ID_escritorio` varchar(10) NOT NULL,
  `cidade` varchar(50) NOT NULL,
  `telefone` varchar(50) NOT NULL,
  `endereco_linha1` varchar(50) NOT NULL,
  `endereco_linha2` varchar(50) DEFAULT NULL,
...
-- Copiando dados para a tabela classicmodels.escritorios: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `escritorios` DISABLE KEYS */;
INSERT INTO `escritorios` (`ID_escritorio`, `cidade`, `telefone`, `endereco_linha1`, `endereco_linha2`, `estado`, `pais`, `codigo_postal`, `territorio`) VALUES
...
-- Copiando estrutura para tabela classicmodels.funcionario
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  KEY `reportsTo` (`ID_chefe`),
  KEY `officeCode` (`ID_escritorio`),
  CONSTRAINT `funcionario_ibfk_1` FOREIGN KEY (`ID_chefe`) REFERENCES `funcionario` (`ID_funcionario`),
  CONSTRAINT `funcionario_ibfk_2` FOREIGN KEY (`ID_escritorio`) REFERENCES `escritorios` (`ID_escritorio`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela classicmodels.funcionario: ~23 rows (aproximadamente)
/*!40000 ALTER TABLE `funcionario` DISABLE KEYS */;
INSERT INTO `funcionario` (`ID_funcionario`, `sobrenome`, `nome`, `extension`, `email`, `ID_escritorio`, `ID_chefe`, `cargo`) VALUES
...
-- Copiando estrutura para tabela classicmodels.item_venda
CREATE TABLE IF NOT EXISTS `item_venda` (
  ...
  KEY `productCode` (`ID_produto`),
  CONSTRAINT `item_venda_ibfk_1` FOREIGN KEY (`ID_venda`) REFERENCES `venda` (`ID_venda`),
  CONSTRAINT `item_venda_ibfk_2` FOREIGN KEY (`ID_produto`) REFERENCES `produtos` (`ID_produto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela classicmodels.item_venda: ~2.996 rows (aproximadamente)
/*!40000 ALTER TABLE `item_venda` DISABLE KEYS */;
INSERT INTO `item_venda` (`ID_venda`, `ID_produto`, `qtd`, `preco_individual`, `orderLineNumber`) VALUES
...
-- Copiando estrutura para tabela classicmodels.pagamentos
CREATE TABLE IF NOT EXISTS `pagamentos` (
  `ID_cliente` int(11) NOT NULL,
  `checkNumber` varchar(50) NOT NULL,
  `data_pagameto` date NOT NULL,
  `valor` decimal(10,2) NOT NULL,
  PRIMARY KEY (`ID_cliente`,`checkNumber`),
  CONSTRAINT `pagamentos_ibfk_1` FOREIGN KEY (`ID_cliente`) REFERENCES `clientes` (`ID_cliente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela classicmodels.pagamentos: ~273 rows (aproximadamente)
/*!40000 ALTER TABLE `pagamentos` DISABLE KEYS */;
INSERT INTO `pagamentos` (`ID_cliente`, `checkNumber`, `data_pagameto`, `valor`) VALUES
...
-- Copiando estrutura para tabela classicmodels.produtos
CREATE TABLE IF NOT EXISTS `produtos` (
  `ID_produto` varchar(15) NOT NULL,
  `nome_produto` varchar(70) NOT NULL,
  `ID_categoria` varchar(50) NOT NULL,
  `escala_produto` varchar(10) NOT NULL,
  `productVendor` varchar(50) NOT NULL,
  `descricao_produto` text NOT NULL,
  `qtd_em_estoque` smallint(6) NOT NULL,
  `preco_compra` decimal(10,2) NOT NULL,
  `preco_venda` decimal(10,2) NOT NULL,
  PRIMARY KEY (`ID_produto`),
  KEY `productLine` (`ID_categoria`),
  CONSTRAINT `produtos_ibfk_1` FOREIGN KEY (`ID_categoria`) REFERENCES `categorias` (`ID_categoria`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela classicmodels.produtos: ~110 rows (aproximadamente)
/*!40000 ALTER TABLE `produtos` DISABLE KEYS */;
INSERT INTO `produtos` (`ID_produto`, `nome_produto`, `ID_categoria`, `escala_produto`, `productVendor`, `descricao_produto`, `qtd_em_estoque`, `preco_compra`, `preco_venda`) VALUES
...
-- Copiando estrutura para tabela classicmodels.venda
CREATE TABLE IF NOT EXISTS `venda` (
  ...
  KEY `customerNumber` (`ID_cliente`),
  CONSTRAINT `venda_ibfk_1` FOREIGN KEY (`ID_cliente`) REFERENCES `clientes` (`ID_cliente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela classicmodels.venda: ~326 rows (aproximadamente)
/*!40000 ALTER TABLE `venda` DISABLE KEYS */;
INSERT INTO `venda` (`ID_venda`, `data_venda`, `data_entrega`, `data_envio`, `status`, `comentarios`, `ID_cliente`) VALUES
